...
cmd += ' DEF:swap=rrd/swap.rrd:swap:AVERAGE'
...
cmd += ' DEF:swap_min=rrd/swap.rrd:swap:MIN'
...
cmd += ' DEF:swap_max=rrd/swap.rrd:swap:MAX'
...
cmd += ' CDEF:smin=csum,swap_min,+'
cmd += ' CDEF:smax=csum,swap_max,+'
cmd += ' CDEF:ssum=csum,swap,+'

cmd += ' AREA:ssum#ff0000:"Swap " '
cmd += ' AREA:smin#cccc00 '
cmd += ' VDEF:maxS=swap_max,MAXIMUM'
cmd += ' VDEF:minS=swap_min,MINIMUM'
cmd += ' VDEF:avgS=swap,AVERAGE'
cmd += ' GPRINT:minS:"Min %6.2lf %sB"'
cmd += ' GPRINT:avgS:"Avg %6.2lf %sB"'
cmd += ' GPRINT:maxS:"Max %6.2lf %sB\\n"'
